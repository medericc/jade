...
       <p>les couleurs : Rouy, négrẹ, blanc, blu (blau le choc), brun/marroû, bért/de, rose,briulét/te, màubẹ (maube la fleur), irandye, gris, yàunẹ (mouyòu pour l’oeuf)</p>   </> 
  ) 
},
{
...
      <p>les mois (lous més) : yambiè, heurè, mars, abriu, may, juin, yulhét, aoust, setémẹ, ouctoùbrẹ, noubémbrẹ, decémẹ.</p>  </>
  )
}
,
{

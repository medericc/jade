    ...
    <main style={{ padding: 20, maxWidth: 1200, margin: 'auto' }}>
      ...
      {tab === 'rules' && (
        <div style={{ marginTop:20, lineHeight:1.6 }}>
         ...
         <p> pronom (qui ne se disent pas à part pour dire Moi, toi, lui..) : 'You','Tu','Éth/Ére','Nousauts','Bousauts','Eths/Éres'</p>
        ...
        <p>2e groupe : arrìdẹ « rire » → arridut</p> <p>aucìdẹ « tuer » → aucidut</p> <p>bédẹ « voir » → bis/biste</p> <p>bìbẹ « vivre » → biscut/biscude</p> <p>biénẹ « venir » → bienut</p> <p>còsẹ « cuire » → coéyt/coéyte</p> <p>counéchẹ « connaître » → counechut</p> <p>crédẹ « croire » → credut</p> <p>débẹ « devoir » → debut</p> <p>dìsẹ « dire » → dit/dite</p> <p>escrìbẹ « écrire » → escribut</p> <p>ha « faire » → hèyt/hèyte</p> <p>léyẹ « lire » → leyut</p> <p>paréchẹ « paraître » → parechut</p> <p>pèrdẹ « perdre » → perdut</p> <p>plàgnẹ « plaindre » → plangut/plagnut</p> <p>plàsẹ « plaire » → plagut/plasut</p> <p>prénẹ « prendre » → prés/prése</p> <p>roùmpẹ « rompre » → arrout/roumput</p> <p>sèdẹ « asseoir » → sedut</p> <p>tiénẹ « tenir » → tienut</p> <p>tòrsẹ « tordre » → tourcut/toursut</p>

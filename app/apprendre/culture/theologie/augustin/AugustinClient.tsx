...
const teachings = [
...

  {
    ...
    textBe: `La bertadère pregàri qu'éy û "desi countinu" neurit per la fè, l'esperance e la caritat. La pregàri ne sèr pas ta assabenta Diu, mé à-d exerça e dilata lou noùste desi. Méy lou noùstẹ desi qu'éy gran, méy que debieném capàblẹs de recébẹ lous dats qui Diu prepare. Las paraules soun aquiu soùnquẹ ta-ns rapela à nous-medichs ço qui demandam e ta rebiscoula lou noùste arséc quoan bade dousse.`
  },
{
  ...
  },
  {
    ...
    textBe: `Lou òmi urous n'éy pas lou qui hè ço qui bòu (permou qui poudém boùle lou mau), mé lou qui a tout ço qui bòu, à coundicioû de ne boùle soùnquẹ ço qui coumbiéne. La pregàri ne s'estanquera soùnquẹ quoan seram héns la tèrre dous bibens, aquiu oun ne demandam pas méy lou bê, més oun qu'ou coùntemplam.`
  }
]

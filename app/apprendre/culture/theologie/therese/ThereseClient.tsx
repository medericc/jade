...
const intro3 = {
  ...
  be: {
    ...
    content: "L’àmne pot manca d’umilitat, que-s crét merita méy per las soûes obres mé que cau se bédẹ coum gouyes chic utìlẹs. L’àmne ùmblẹ trobe méy de pats héns la soumìssiou e la bigou dous sequères qui d’àutẹs héns lous bounics spirituaus. Diu retìre bèth cop las soûes gràcies ta que l’àmne sènte la soûe pròpi dèche e qui sàpi couneche-s. Aquére esprabe qu’éy ûe misericorde permou qui mène l’umilitat. Per exémple, ûe persoune rìchẹ qui pèrdẹ û tros dou soû bé (en goardan toutû proû) e qui se-n tesique, que proùbe qui n’éy pas prèste à tout quita tau Segnou. Boulé aumenta la soûe fourtune, medich dap bounes entencioûs, qu'empache d'atégnẹ las demoures méy tagnénes dou gran Réy (ayda lous pràubẹs). Si ûe leuyère mauheyte a l'aunou e produsech û souci qui ne-s pot pas mata, qu'éy lou sìnnẹ qui n'èm pas encoère tout à fèyt mèstẹ de las soûes passioûs. Que tirem en daban per aquéth camì per ûe pregounde umilitat meylèu que per las hòrtes penitences dou cos, qui soun dou darrè.",
...
<> 
 ...
 <>       
      ...
      Thérèse que coumpare l’àmne en estat de pecat mortèu a ûe presoû escure, abùglẹ e mude. Û pecadou éy coum ligat a û pau, en mourin de hàmi au ras de la maschacûre qui ne pot pas touca.
            ...
            <p>
       Que dit dounc de prega ta aquéres àmnes. Ta ûe àmne en estat de pecat mortèu, Diu éy toustém au miéy de l’àmne, mé lou pecat qu’ayi coum û boèle négrẹ, la luts ne se pot pas méy bédẹ ni esta recebude.
           </p>
